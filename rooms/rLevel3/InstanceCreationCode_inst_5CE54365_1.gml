...
ds_list_add(waves,[4,oEnemy,1,20]);
ds_list_add(waves,[4,oEnemy,1,30]);

ds_list_add(waves,[5,oEnemy,1,10]);
ds_list_add(waves,[5,oEnemy,1,20]);
ds_list_add(waves,[5,oEnemy,1,30]);


ds_list_add(waves,[6,oBigEnemy,1,0]);
